...
driver = webdriver.Chrome(executable_path='/Users/nikitamozharovskii/Desktop/Proga/Charm/QA_Selenium/chromedriver')

driver.get('https://www.asos.com/ru/men/')

#Проверка функции поиск по сайту
...
#Проверка функции перехода по ссылке на социальные сети сайта через кнопку
